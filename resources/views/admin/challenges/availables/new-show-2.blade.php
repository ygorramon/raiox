                                                                            ...
                                                                            <div class="modal-dialog modal-lg">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="mb-3">
                                                                                            ...
                                                                                            <div class="d-flex flex-wrap gap-2">
                                                                                                @foreach($soneca['associacoes']['comoAdormeceu'] as $associacao)
                                                                                                    <span class="badge bg-info p-2">{{ $associacao }}</span>
                                                                                                @endforeach
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <div class="d-flex flex-wrap gap-2">
                                                                                                    @foreach($soneca['associacoes']['depoisAdormecer'] as $local)
                                                                                                        <span class="badge bg-success p-2">{{ $local }}</span>
                                                                                                    @endforeach
                                                                                                </div>
                                                                                            </div>
                                                                                        @endif
                                                                                        ...
                                                                                        <!-- Detalhes adicionais -->
                                                                                        @if(isset($soneca['associacoes']['detalhesAdormecer']) && count($soneca['associacoes']['detalhesAdormecer']) > 0)
                                                                                            <div class="mb-3">
                                                                                                <h6>📝 Detalhes:</h6>
                                                                                                <div class="card">
                                                                                                    <div class="card-body">
                                                                                                        @foreach($soneca['associacoes']['detalhesAdormecer'] as $chave => $valor)
                                                                                                            <p><strong>{{ ucfirst($chave) }}:</strong> {{ $valor }}</p>
                                                                                                        @endforeach
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>

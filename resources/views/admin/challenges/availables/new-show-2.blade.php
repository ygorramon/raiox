                ...
                @endif
                                                        ...
                                                        @if($ritual)
                                                            ...
                                                            <div class="alert alert-warning mb-3">
                                                                ...
                                                                Janela ideal:
                                                                {{ getJanela(now()->diffInDays(\Carbon\Carbon::parse($challenge->client->birthBaby)))->janelaIdealInicio }} -
                                                                {{ getJanela(now()->diffInDays(\Carbon\Carbon::parse($challenge->client->birthBaby)))->janelaIdealFim }}min
                                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        <span class="badge bg-{{ $resposta['resposta'] == 'Sim' ? 'success' : ($resposta['resposta'] == 'Não' ? 'danger' : 'info') }}">
                                            {{ $resposta['resposta'] }}
                                        </span>
                                    </p>

                                                                                                                ...
                                                                                                                @if(isset($soneca['associacoes']['comoAdormeceu']))
                                                                                                                    @php
                                                                                                                        ...
                                                                                                                        foreach ($soneca['associacoes']['comoAdormeceu'] as $associacao) {
                                                                                                                            if (str_contains($associacao, 'Outro:') || str_contains($associacao, 'Outros:')) {
                                                                                                                                $temOutrosLongo = true;
                                                                                                                                                ...
                                                                                                                                                @foreach($soneca['associacoes']['comoAdormeceu'] as $associacao)
                                                                                                                                                    @if(str_contains($associacao, 'Outro:') || str_contains($associacao, 'Outros:'))
                                                                                                                                                        <div class="mb-2 p-2 bg-light rounded">
                                                                                                                                                            ...
                                                                                                                                                            <span
                                                                                                                                                                class="text-dark">{{ Str::replace(['Outro:', 'Outros:'], '', $associacao) }}</span>
                                                                                                                                                        </div>
                                                                                                                                                    @else
                                                                                                                                        ...
                                                                                                                                        <div class="mb-3">
                                                                                                                                            ...
                                                                                                                                            <div class="d-flex flex-wrap gap-2">
                                                                                                                                                @foreach($soneca['associacoes']['depoisAdormecer'] as $local)
                                                                                                                                                    @if(str_contains($local, 'Outro:') || str_contains($local, 'Outros:'))
                                                                                                                                                        <div class="w-100 mb-2 p-2 bg-light rounded">
                                                                                                                                                            <strong>Outros:</strong> {{ Str::replace(['Outro:', 'Outros:'], '', $local) }}
                                                                                                                                                        </div>
                                                                                                                                                    @else

                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($nap->duration<40) <span class="badge bg-black">{{$nap->duration}}</span>
                                            @else
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-black"> {{$nap->window-$nap->windowSignalSlept}}</span>
                                        @else
                                        <span class="badge bg-black"> {{$nap->window-$nap->windowSignalSlept}} </span>
                                        @endif
                                ...
                                <tr>
                                    ...
                                    @endphp
                                        ...
                                        <span class="badge bg-black"> {{$ritual->window-$ritual->windowSignalSlept}}</span>
                                        @else
                                        <span class="badge bg-black"> {{$ritual->window-$ritual->windowSignalSlept}} </span>
                                        @endif

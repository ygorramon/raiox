        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-6 ">
                    ...
                    <div>
                        <input type="text" readonly class="form-control" id="nomeMae" value="" placeholder="nomeMae">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div>
                        <input type="text"  class="form-control" id="idadeBebe" value="{{now()->diffInDays(\Carbon\Carbon::parse($challenge->client->birthBaby))}} / {{now()->diffInMonths(\Carbon\Carbon::parse($challenge->client->birthBaby))}}" placeholder="nomeMae">
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-3 ">
                    ...
                    <div>
                        ...
                        <span class="badge bg-black">{{$challenge->form->weightGain}}</span>
                        @else
                        <span class="badge bg-black">Não Sabe ou Perdeu Peso</span>
                        @endif
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 ">
                    ...
                    <div>
                        ...
                        <span class="badge bg-black">Adequado</span>
                        @else
                        <span class="badge bg-black">{{$challenge->form->energyExpenditure}}</span>
                        @endif
                    </div>
                </div>
                <div class="col-md-3 ">
                ...
                <div class="col-md-3 ">
                    ...
                    <div>
                        ...
                        <span class="badge bg-black">Totalmente escuro</span>
                        @endif
                        @if($challenge->form->environmentNapsLights=='P')
                        <span class="badge bg-black">Parcialmente escuro</span>
                        @endif
                        @if($challenge->form->environmentNapsLights=='C')
                        <span class="badge bg-black">Ambiente claro</span>
                        @endif
                    </div>
                </div>
                <div class="col-md-3 ">
                    ...
                    <div>
                        ...
                        <span class="badge bg-black">Silencioso</span>
                        @endif
                        @if($challenge->form->environmentNapsNoises=='P')
                        <span class="badge bg-black">Parcialmente silencioso</span>
                        @endif
                        @if($challenge->form->environmentNapsNoises=='C')
                        <span class="badge bg-black">Com ruídos</span>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-md-3 ">
                    ...
                    <div>
                        ...
                        <span class="badge bg-black">Adequada</span>
                        @endif
                        @if($challenge->form->environmentNapsTemperature=='C')
                        <span class="badge bg-black">Calor</span>
                        @endif
                        ...
                        <span class="badge bg-black">Não sei</span>
                        @endif
                    </div>
                </div>
                <div class="col-md-3 ">
                    ...
                    <div>
                        ...
                        <span class="badge bg-black">Adormece no colo e é levado ao berço</span>
                        <br>
                        @endif
                        ...
                        <span class="badge bg-black">dormece no colo e é levado ao berço</span>
                        <br>
                        @endif
                        @if($challenge->form->whereSleepLap=='S')
                        <span class="badge bg-black">Adormece e dorme toda a soneca no colo</span>
                        ...
                        <span class="badge bg-black">Rede</span>
                        <br>
                        @endif
                        @if($challenge->form->whereSleepOther!='N')
                        <span class="badge bg-black">{{$challenge->form->whereSleepOther}}</span>
                        <br>
                        @endif
                ...
                <div class="col-md-3 ">
                    ...
                    <div>
                        ...
                        <span class="badge bg-black">Sempre alegre e disposto</span>
                        @endif
                        @if($challenge->form->wakeUpNap=='ES')
                        <span class="badge bg-black">Eventualmente acorda ainda com sono</span>
                        @endif
                        @if($challenge->form->wakeUpNap=='FS')
                        <span class="badge bg-black">Frequentemente acorda ainda com sono</span>
                        @endif
            ...
            <div class="row">
                ...
                <div class="col-md-3 ">
                    ...
                    <div>
                        ...
                        <span class="badge bg-black">{{$challenge->form->ritualAssociationOther}}</span>
                        <br>
                        @endif
            ...
            <div class="row">
                <div class="col-md-12 ">
                    ...
                    <div>
                        ...
                        <span class="badge bg-black">Imaturidade</span>

                        @endif

                        @if($challenge->form->conclusionHungry=='S')
                        <span class="badge bg-black">Fome</span>

                        @endif
                        @if($challenge->form->conclusionAche=='S')
                        <span class="badge bg-black">Dor</span>

                        @endif
                        @if($challenge->form->conclusionJump=='S')
                        <span class="badge bg-black">Salto de Desenvolvimento</span>

                        @endif

                        @if($challenge->form->conclusionAnguish=='S')
                        <span class="badge bg-black">Angústia da Separação</span>

                        @endif
                        @if($challenge->form->conclusionScreens=='S')
                        <span class="badge bg-black">Telas</span>

                        @endif
                        @if($challenge->form->conclusionScreens=='S')
                        <span class="badge bg-black">Estresse excessivo</span>

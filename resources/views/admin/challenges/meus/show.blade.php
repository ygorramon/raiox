            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6 ">
                        ...
                        <div>
                            <input type="text" readonly class="form-control" id="nomeMae"
                                @if ($challenge->form->typeEatingRoutine == 1) value="Aleitamento Materno Exclusivo" @endif
            ...
            <div class="row">
                @foreach ($challenge->analyzes as $analyze)
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">DIA {{ $analyze->day }} -
                                    {{ \Carbon\Carbon::parse($analyze->date)->format('d/m/Y') }}</h3>
                            ...
                            <div class="card-body">
                                ...
                                <h5>Efeito Vulcânico:
                                    ...
                                    @else
                                        <span class="badge bg-red">SIM</span>
                                    @endif
                                    Janela para a Idade <span
                                        class="badge bg-green">({{ getIdade($challenge->client->birthBaby) }}) DIAS</span>
                                    MIN: <span
                                        class="badge bg-green">{{ getJanela(getIdade($challenge->client->birthBaby))->janelaIdealInicio }}</span>
                                    - MAX: <span
                                        class="badge bg-green">{{ getJanela(now()->diffInDays(\Carbon\Carbon::parse($challenge->client->birthBaby)))->janelaIdealFim }}</span>
                                    MAX Sinal de Sono: <span
                                        class="badge bg-green">{{ getJanela(getIdade($challenge->client->birthBaby))->janelaIdealFim - 30 }}</span>

                            ...
                            <div class="step-content">
                                <div class="row">
                                    <div class="input-field col m6 s12">
                                        ...
                                        <input type="text" id="date" name="date"   @if (
                                                                    isset(
                                                                        $challenge->analyzes()->where('day', $day)->first()->dados()->first()->date))
                                        value="{{ old('date',formatDateAndTime($challenge->analyzes()->where('day', $day)->first()->dados()->first()->date))  }}"
                                        @else
                                        value="{{old('date')}}"
                                        @endif class="datepicker">
                                    ...
                                    <div class="input-field col m6 s12">
                                        ...
                                        @if (
                                                                    isset(
                                                                        $challenge->analyzes()->where('day', $day)->first()->dados()->first()->timeWokeUp))

...
@section('content')
    ...
    <div id="colica_subtipos" style="display: none; margin-left: 20px;">
        <p>
            <label>
                <input type="checkbox" class="filled-in" name="colica_opcao[]" value="colica" />
                <span>Cólicas</span>
            </label>
        </p>
        <p>
            <label>
                <input type="checkbox" class="filled-in" name="colica_opcao[]" value="gases" />
                <span>Gases</span>
            </label>
        </p>
        <p>
            <label>
                <input type="checkbox" class="filled-in" name="colica_opcao[]" value="disquesia" />
                <span>Disquesia</span>
            </label>
        </p>
        <p>
            <label>
                <input type="checkbox" class="filled-in" name="colica_opcao[]" value="nao_sei" />
                <span>Não sei a diferença</span>
            </label>
        </p>
    </div>
    ...
    <div id="refluxo_subtipos" style="display: none; margin-left: 20px;">
        <p>
            <label>
                <input type="checkbox" class="filled-in" name="refluxo_opcao[]" value="fisiologico" />
                <span>Refluxo fisiológico</span>
            </label>
        </p>
        <p>
            <label>
                <input type="checkbox" class="filled-in" name="refluxo_opcao[]" value="patologico" />
                <span>Doença do refluxo</span>
            </label>
        </p>
        <p>
            <label>
                <input type="checkbox" class="filled-in" name="refluxo_opcao[]" value="nao_sei" />
                <span>Não sei a diferença</span>
            </label>
        </p>
    </div>

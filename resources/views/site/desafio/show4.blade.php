                                                                                                                                                ...
                                                                                                                                                <td>
                                                                                                                                                    @if($liberado)
                                                                                                                                                        @if($rotina && $rotina->data)
                                                                                                                                                            <a href="{{ route('rotinas.view', [$challenge->id, $day]) }}" class="btn waves-effect waves-light blue btn-sm">
                                                                                                                                                                <i class="material-icons left">visibility</i>
                                                                                                                                                                Ver Rotina
                                                                                                                                                            </a>
                                                                                                                                                            <br>
                                                                                                                                                            <small class="green-text">
                                                                                                                                                                Preenchido em: {{ \Carbon\Carbon::parse($rotina->data)->format('d/m/Y H:i') }}
                                                                                                                                                            </small>
                                                                                                                                                        @else

                    ...
                    <div class="section">
                        ...
                        @foreach($sonecas as $index => $soneca)
                            <div class="soneca-item">
                                ...
                                <!-- Container das Recomendações (inicialmente oculto) -->
                                <div id="recomendacoes-{{ $index }}" class="recomendacoes-container" style="display: none; margin-top: 15px; padding: 20px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #ff9800;">
                                    <!-- As recomendações serão carregadas aqui via JavaScript -->
                                </div>
            ...
            @else
                <div class="section">
                    <div class="card-panel red lighten-4">
                        <h4>Rotina não encontrada</h4>
                        <p>Não foi possível encontrar a rotina para o dia especificado.</p>
                        <a href="{{ url()->previous() }}" class="btn waves-effect waves-light">Voltar</a>
                    </div>
                </div>
            @endif
        </div>
